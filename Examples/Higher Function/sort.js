...
var res1 = arr.every(function(value) {
    return value % 2 === 0 // Whether all the EVEN number
})
console.log(res1)

var res2 = arr.every(function(value) {
    return value >= 0 // Whether all the POSITIVE number''
})
console.log(res2)

var res3 = arr.some(function(value) {
    return value % 2 === 1 // Whether all the ODD number
})
console.log(res3)

var res4 = arr.some(function(value) {
    return value < 0 // Whether all the NEGATIVE number
})
console.log(res4)